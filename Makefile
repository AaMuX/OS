...
OBJS = entry.o trapvec.o mtrapvec.o timervec.o start.o main.o uart.o console.o printf.o pmm.o pagetable.o kvminit.o power.o trap.o sched.o proc.o swtch.o mem.o string.o
...
proc.o: kernel/proc.c kernel/proc.h kernel/riscv.h kernel/trap.h
	$(CC) $(CFLAGS) -c -o $@ $<
